...
9. On the Virtual machines blade, click the ellipsis to the right of the **x20533E1001-vm1** entry and click **Connect**.
...
14. In the Remote Desktop Session to x20533E1001-vm1, click **Start**, right-click **Windows PowerShell ISE**, click **More**, and click **Run as administrator**.
